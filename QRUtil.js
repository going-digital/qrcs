...
/** Size of length value in bits
* @param {Number} mode Character encoding
* @param {Number} type QR Code version
* @return {Number} size in bits
*/
...
/** Evaluate QR code score
* according to ISO18004:2006 §6.8.2.1
* @param {Object} qrCode
* @return {Number} score
*/
QRUtil.getLostPoint = function(qrCode) {
  ...
  // Block of modules in same colour
